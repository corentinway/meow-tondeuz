...
class MowerFactoryTest {
    ...
    void should_return_the_first_mower_given_a_valid_instruction_file(String lineInstruction, String orientationName) throws IllegalInstructionException {
        // WHEN
    ...
    void should_throw_some_exception_given_invalid_initial_mower_position(String instructionLine, String expectedMessage, String causeExceptionName) {
        // GIVEN
